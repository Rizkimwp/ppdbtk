                        ...
                        <form class="form-sample" action="{{ route('calon-siswa.store') }}" method="POST"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <span id="rangeValue">2.5</span>CM <!-- Awalnya diatur ke nilai tengah -->
                                        </div>
                                        @error('tinggi_badan')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="range"
                                                ...
                                                id="berat_badan" name="berat_badan" min="0" max="100"
                                                value="{{ old('berat_badan') }}" step="0.5" id="customRange2"
                                                oninput="updateRangeBerat(this.value)">
                                            <span id="rangeValue2">2.5</span>KG <!-- Awalnya diatur ke nilai tengah -->
                                        </div>
                                        @error('berat_badan')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="form-select @error('pekerjaan_ayah_id') is-invalid @enderror"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="form-select @error('pekerjaan_ibu_id') is-invalid @enderror"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="form-select @error('pendidikan_ayah_id') is-invalid @enderror"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="form-select @error('pendidikan_ibu_id') is-invalid @enderror"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input class="form-control @error('tahun_lahir_ayah') is-invalid @enderror"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input class="form-control @error('tahun_lahir_ibu') is-invalid @enderror"
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text"
                                                ...
                                                value="{{ old('nama_wali') }}" id="nama_wali" name="nama_wali" />
                                        </div>
                                        @error('nama_wali')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="form-select @error('pekerjaan_wali_id') is-invalid @enderror"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text"
                                                ...
                                                value="{{ old('nomor_wali') }}" id="" name="nomor_wali" />
                                        </div>
                                        @error('nomor_wali')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                            ...
                            @foreach ($listBerkas as $berkas)
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            <label class="col-sm-3 col-form-label">{{ $berkas->nama_berkas }} @if ($berkas->wajib == 1)
                                            ...
                                            <div class="input-group col-xs-12">
                                                ...
                                                @else
                                                    ...
                                                    <input type="text"
                                                        class="form-control file-upload-info file-input-value" disabled
                                                        placeholder="Upload File">
                                                    <span class="input-group-append">
                                                        <button
                                                            class="file-upload-browse btn btn-gradient-primary py-3 btn-upload"
                            ...
                            <div class="row">
                                <div class="col-md-12 text-end d-grid gap-2">
                                    <button class="btn btn-gradient-primary w-full btn-lg">DAFTAR</button>
                                </div>
                            </div>
                        </form>
                    </div>
